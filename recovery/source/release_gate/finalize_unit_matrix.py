...
EXPECTED: dict[str, str] = {
    ...
    "ai-audit-concurrency": "tests/test_ai_audit_concurrency.py",
    ...
    "isolated-processing": "tests/test_isolated_processing.py",
    "l5-iz017": "tests/test_l5_iz017_regression.py",
    "m1-ui": "tests/test_m1_ui.py",
    "print-extraction": "tests/test_print_extraction.py",
    "product-workflows": "tests/test_product_workflows.py",
    "project-lookup": "tests/test_project_lookup_resilience.py",
    "project-store-concurrency": "tests/test_project_store_concurrency.py",
    "redteam": "tests/test_redteam_adversarial.py",
    "redteam-contracts": "tests/test_redteam_contracts.py",
    "second-core": "tests/test_second_core_failure_regression.py",
    "segmentation-governance": "tests/test_segmentation_governance.py",
