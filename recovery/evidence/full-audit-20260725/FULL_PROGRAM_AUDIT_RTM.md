...
1. **P0/P1 — physical L5 authorization gap.** The RTM says physical user-machine L5 is mandatory, but the current finalizer/workflow does not consume an independently pinned physical-L5 evidence record as a mandatory authorization input.
